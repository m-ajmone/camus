...
public class Controller implements Initializable {
    ...
    private void onRandomize(Event evt) {
        createBoard(DEFAULT_SIZE, (int) countSlider.getValue()/100);
    }
    ...
    private void onSlide(Event evt) {
        countSlider.valueProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observable,
                ...
                createBoard(DEFAULT_SIZE, (int) newValue.intValue()/100);
            }
        });
    }
    ...
    private void createBoard(int size, int possibleState) {
        board = new Board(size, size, possibleState);
        createDisplay();
    }
        ...
        ChangeListener<Number> sizeListener = new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                ...
                if (newWidth > 250 && Math.abs(newWidth - windowWidth) >= 50) {
                    ...
                    cellSizePx = newWidth / (DEFAULT_SIZE + 35);
                    createDisplay();
                }
            }
        };
